...
def index(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'blog.html', {'isna_h2_list':isna_h2_list , 'isna_p1_list':isna_p1_list , 'isna_url_list':isna_url_list
                                             , 'isna_time_list':isna_time_list , 'irna_h2_list':irna_h2_list , 'irna_p1_list':irna_p1_list
                                             ,'irna_url_list':isna_url_list, 'irna_time_list':irna_time_list})
    else:
